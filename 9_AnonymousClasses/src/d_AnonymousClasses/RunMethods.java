...
public class RunMethods {
    public static void main(String[] args) {
        ...
        // Using anonymous class - notice that "Comparator" is abstract class implementing the comparable interface
        ...
        //Also - anonymous classes on the fly!
        ...
        //Replace with Lambda expressions by just hovering over the previous code.
        sortIt(storeEmployees, (o1, o2) -> o1.getName().compareTo(o2.getName()));
    }

    public static <T> void sortIt(
            List<T> list,
            Comparator<? super T> comparator //lower bounded wildcard. Use either same as T or super type of T.
    ){
